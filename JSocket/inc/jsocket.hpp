...
namespace Tools
{
    ...
    public:
        ...
        */
        ...
        void SetTimeOut(unsigned int timeOutSec, unsigned int timeOutUSec)
        {
    ...
    protected:
        ...
        CSocket(SocketType type, NetworkLayerProtocol protocol, int timeOutSec, int timeOutUSec) throw(CSocketException);
